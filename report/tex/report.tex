...
\captionof{listing}{Parallelisierte k-means Implementierung mit OpenMP
...
%\begin{figure}[htbp]
%  \centering
%    \includesvg[width=0.8\textwidth]{report/resources/C_OpenMP_boxplots}
...
\captionof{listing}{Parallelisierte k-means Implementierung mit CUDA (kmean.cu)
...
\begin{figure}[htbp]
  \begin{center}
    ...
    report/resources/stall_reasons.png}
  \end{center}
